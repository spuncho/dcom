    ...
    /* [disable_consistency_check][size_is][out] */ HRESULT *pResults)
{
    ...
    _RetVal = NdrClientCall2(
                  ...
                  (PFORMAT_STRING) &dcom__MIDL_ProcFormatString.Format[0],
                  ( unsigned char * )&hRpc);
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    NdrClientCall2(
                  ...
                  (PFORMAT_STRING) &dcom__MIDL_ProcFormatString.Format[148],
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IRemoteSCMActivator_StubDesc,
                  (PFORMAT_STRING) &dcom__MIDL_ProcFormatString.Format[176],
                  ( unsigned char * )&IDL_handle);
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IRemoteSCMActivator_StubDesc,
                  (PFORMAT_STRING) &dcom__MIDL_ProcFormatString.Format[204],
                  ( unsigned char * )&IDL_handle);
    ...
    /* [out] */ MInterfacePointer **ppActProperties)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IRemoteSCMActivator_StubDesc,
                  (PFORMAT_STRING) &dcom__MIDL_ProcFormatString.Format[232],
                  ( unsigned char * )&rpc);
    ...
    /* [out] */ MInterfacePointer **ppActProperties)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IRemoteSCMActivator_StubDesc,
                  (PFORMAT_STRING) &dcom__MIDL_ProcFormatString.Format[290],
                  ( unsigned char * )&rpc);
    return ( HRESULT  )_RetVal.Simple;
    ...
    /* [ref][out] */ DWORD *pAuthnHint)
{
    ...
    _RetVal = NdrClientCall2(
                  ...
                  (PFORMAT_STRING) &dcom__MIDL_ProcFormatString.Format[354],
                  ( unsigned char * )&hRpc);
    return ( error_status_t  )_RetVal.Simple;
    ...
    /* [in] */ SETID *pSetId)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IObjectExporter_StubDesc,
                  (PFORMAT_STRING) &dcom__MIDL_ProcFormatString.Format[424],
                  ( unsigned char * )&hRpc);
    return ( error_status_t  )_RetVal.Simple;
    ...
    /* [out] */ unsigned short *pPingBackoffFactor)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IObjectExporter_StubDesc,
                  (PFORMAT_STRING) &dcom__MIDL_ProcFormatString.Format[464],
                  ( unsigned char * )&hRpc);
    return ( error_status_t  )_RetVal.Simple;
    ...
    /* [in] */ handle_t hRpc)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IObjectExporter_StubDesc,
                  (PFORMAT_STRING) &dcom__MIDL_ProcFormatString.Format[540],
                  ( unsigned char * )&hRpc);
    return ( error_status_t  )_RetVal.Simple;
    ...
    /* [ref][out] */ COMVERSION *pComVersion)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IObjectExporter_StubDesc,
                  (PFORMAT_STRING) &dcom__MIDL_ProcFormatString.Format[574],
                  ( unsigned char * )&hRpc);
    return ( error_status_t  )_RetVal.Simple;
    ...
    /* [ref][out] */ DWORD *pReserved)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IObjectExporter_StubDesc,
                  (PFORMAT_STRING) &dcom__MIDL_ProcFormatString.Format[650],
                  ( unsigned char * )&hRpc);
    return ( error_status_t  )_RetVal.Simple;
